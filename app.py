...
{"title": ["I Gotta Feeling","I Got A Feeling"],         "file": "music/I_Gotta_Feeling-Black_Eyed_Peas.mp3",      "artist": ["Black Eyed Peas", "The Black Eyed Peas"]},
...
def process_guess():
    ...
    # Bonus artist points
    if session.get('guess_artist', False) and any(
            user_artist_guess.lower() == artist.lower() for artist in correct_artists):
        session['score'] += 10
        points_earned += 10
